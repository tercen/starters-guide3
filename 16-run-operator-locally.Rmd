...
``.ids`` is a unqiue integer identifier given to each cell of the data.

``.value`` are the data value(s) in each cell.
...
You have performed a local compuation and sent the results to Tercen for viewing.
