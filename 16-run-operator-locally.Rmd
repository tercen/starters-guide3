...
In this section you run an operator you created in a previous section, but locally (i.e. on your own computer not on Tercen).

Here is an example for the R ``mean`` operator used previously but this time it is executed locally from your favorite development environment. This example is a brief introduction on creating operators locally.
